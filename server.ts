...
const io = new Server(server, {cors: {  origin: [ "https://goobapp.github.io", "https://goobapp.org", 'http://localhost:5173' ]}}); // Create a new Socket.IO instance using the created HTTP server
